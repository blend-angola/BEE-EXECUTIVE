  ...
  return (
    <section className="relative py-8 lg:mt-[40px] border-y border-y-beeBorder">
      <Container className="flex flex-col gap-4 my-10">
        <div className="absolute lg:left-0 lg:top-[68px] top-0 left-1/2 -translate-x-1/2 lg:h-[6vh] lg:w-[6vw] h-10 w-6 lg:rounded-r-full rounded-b-full bg-beeYellow-secondary" />
